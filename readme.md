...
![PHP 8.3.31](https://img.shields.io/badge/version-8.3.31-blue?logo=php&labelColor=white) ![WordPress 6.9.4](https://img.shields.io/badge/version-6.9.4-blue?logo=wordpress&labelColor=white&logoColor=black)
...
[Neon](https://neon.tech/) provides a serverless PostgreSQL database with a generous free tier. **Highly recommended for Vercel users** as it supports "zero-config" deployment via the [Neon Vercel Integration](https://neon.tech/docs/guides/vercel).
...
If you use the **Neon Vercel Integration**, the environment variables are automatically configured for you. Otherwise, you'll need to update them manually.
